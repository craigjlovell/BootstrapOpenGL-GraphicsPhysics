...
public:
	...
	void SetRotation(float a_eulerAngles, float a_eulerAngles1, float a_eulerAngles2);
	
	glm::vec3 GetScale() { return m_scale ; }
	void SetScale(glm::vec3 a_scale) { m_transform *= glm::scale(m_transform, a_scale); }
	void SetSize(glm::vec3 a_eulerAngles, glm::vec3 a_eulerAngles1, glm::vec3 a_eulerAngles2);
